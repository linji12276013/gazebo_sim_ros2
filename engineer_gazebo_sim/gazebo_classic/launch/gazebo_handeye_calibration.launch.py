...
def generate_launch_description():
    ...
    world_path = os.path.join(gazebo_pkg_share, 'gazebo_classic', 'worlds', 'handeyeboard.world')
    ...
    static_tf_handeyeboard = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='static_tf_handeyeboard',
        arguments=['1', '0', '0.6', '0', '0', '0', 'world', 'handeyeboard_link'],
        output='screen'
    )
